       ...
       <section class="col-lg-7 connectedSortable">
         ...
         <div class="card">
           <div class="card-header">
                <h3>Edit Service  <a href="{{route('service.view')}}" class="btn btn-outline-success btn-sm float-right"><i class="fa fa-list"></i>Service List</a></h3>
               
           </div><!-- /.card-header -->
           <div class="card-body">
               @include('backend.layouts.SessionMsg')
            <form method="POST" action="{{route('service.update', $edit->id)}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" rows="4" name="long_title">{{$edit->long_title}}</textarea>
                    </div>
                </div>
