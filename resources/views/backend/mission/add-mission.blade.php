       ...
       <section class="col-lg-7 connectedSortable">
         ...
         <div class="card">
           <div class="card-header">
                <h3>Add Mission  <a href="{{route('mission.view')}}" class="btn btn-outline-success btn-sm float-right"><i class="fa fa-list"></i>Mission List</a></h3>
            ...
            <form method="POST" action="{{route('mission.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 offset-md-3">
                       <img id="showImage" src="{{(!empty($editData->image))?URL::to('upload/mission_images/'.$editData->image):URL::to('upload/user_images/no_image.png')}}"  style="widows: inherit; width:150px; height:150px; border:1px solid #042b3d" alt="">
                    </div>
                </div>
