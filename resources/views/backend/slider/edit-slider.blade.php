       ...
       <section class="col-lg-7 connectedSortable">
         ...
         <div class="card">
           <div class="card-header">
                <h3>Edit Slider  <a href="{{route('slider.view')}}" class="btn btn-outline-success btn-sm float-right"><i class="fa fa-list"></i>Slider List</a></h3>
           ...
           <div class="card-body">
            ...
            <form method="POST" action="{{route('slider.update',$edit->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="" type="text" class="form-control" name="long_title" value="{{$edit->long_title}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 offset-md-3">
                       <img id="showImage" src="{{(!empty($edit->image))?URL::to('upload/slider_image/'.$edit->image):URL::to('upload/user_images/no_image.png')}}"  style="widows: inherit; width:150px; height:150px; border:1px solid #042b3d" alt="">
                    </div>
                </div>
