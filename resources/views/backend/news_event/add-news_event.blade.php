       ...
       <section class="col-lg-7 connectedSortable">
         ...
         <div class="card">
           ...
           <div class="card-body">
            ...
            <form method="POST" action="{{route('news_event.store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="datepicker" type="date" class="form-control" name="date" placeholder="YYYY-MM-DD" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="" type="text" class="form-control" name="short_title" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" rows="5" name="long_title"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 offset-md-3">
                       <img id="showImage" src="{{(!empty($editData->image))?URL::to('upload/news_event_images/'.$editData->image):URL::to('upload/user_images/no_image.png')}}"  style="widows: inherit; width:150px; height:150px; border:1px solid #042b3d" alt="">
                    </div>
                </div>
